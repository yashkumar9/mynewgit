...
public class RemoteCapabilities {
    ...
    private String accessKey = ConfigProperties.BROWSER_STACK_ACCESS_KEY.get();
    private String userName = ConfigProperties.BROWSER_STACK_USERNAME.get();
    private String projectName = ConfigProperties.PROJECT_NAME.get();
    private String buildName = ConfigProperties.PROJECT_NAME.get();
    //**********************************************************************
	...
	public MutableCapabilities caps = new MutableCapabilities();

    public RemoteCapabilities(DriverFactory.Platform platform, DriverFactory.Browser browser, AndroidDriver<AndroidElement> driver) {
    ...
    /*public DesiredCapabilities getBrowserstackCapabilities() throws MalformedURLException {
        
        BrowserStackClient browserstackClient = new BrowserStackClient();
        String appurl = browserstackClient.app_id;
        ...
        caps.setCapability("build", "build001");
        caps.setCapability("name", "Bstack-[Java] Sample Test");
        //caps.setCapability("app", "bs://c68d2b806f91fcec849d049ff745d03182582d72");
        caps.setCapability("app", appurl);
        System.out.println("APPURL:" + appurl);
        
        System.out.println(device_name + " : " + platform_version + " : " + projectName + " : " + " : " + buildName  );
        
        driver= myAndroidDriver(userName,accessKey,caps );       
...
*//*        caps.setCapability("project", app_name);
    ...
    public AndroidDriver<AndroidElement> myAndroidDriver(String userName2, String accessKey2, MutableCapabilities caps2 ) throws MalformedURLException{
    	System.out.println("$$$ Have successfully set the android driver");
    	driver = new AndroidDriver<AndroidElement>(new URL("https://"+userName2+":"+accessKey2+"@hub-cloud.browserstack.com/wd/hub"), caps2);
		return this.driver;    	
    }
